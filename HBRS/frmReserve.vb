...
Public Class frmReserve
    ...
    Private Sub bttnSearchGuest_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnSearchGuest.Click
        ...
        ' التأكد من أن الخصائص تم استدعاؤها بشكل صحيح من النموذج الفرعي
        txtGuestName.Text = frmSelectGuest.GuestFullName ' عرض اسم الضيف
        lblGuestID.Text = frmSelectGuest.GuestID.ToString() ' عرض ID الضيف
    ...
    Private Sub bttnSearchRoom_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnSearchRoom.Click
        ...
        ' التأكد من أن الخصائص تم استدعاؤها بشكل صحيح من النموذج الفرعي
        txtRoomNumber.Text = frmSelectRoom.RoomNumber.ToString()
        txtRoomType.Text = frmSelectRoom.RoomType
        txtRoomRate.Text = frmSelectRoom.RoomRate.ToString("C")
    End Sub
    ...
    Private Sub bttnReserve_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles bttnReserve.Click
        ...
        If lblGuestID.Text = "GuestID" Or lblGuestID.Text = Nothing Then
            MsgBox("Please Fill Guest Field", vbInformation, "Note")

        ElseIf txtRoomNumber.Text = Nothing Then
            MsgBox("Please Fill Room Fields", vbInformation, "Note")

            'ElseIf Val(children + adult) = Nothing Then
            '    MsgBox("Please Fill children + adult Fields", vbInformation, "Note")

        ElseIf advance = Nothing Then
            MsgBox("Please Fill advance Field", vbInformation, "Note")

        ElseIf discount = Nothing Then
            MsgBox("Please Fill discount Field", vbInformation, "Note")
