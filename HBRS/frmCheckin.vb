...
Public Class frmCheckin
    ...
    Private Sub frmCheckin_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        dtCheckOutDate.Text = Now.AddDays(1D).ToString
        transID()
        pop_discount()
        display_checkin()
    End Sub
    ...
    Private Sub frmCheckin_Load_1(sender As Object, e As EventArgs) Handles MyBase.Load
