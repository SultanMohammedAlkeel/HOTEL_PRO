Public Class frmMain
    ...
    'End Sub
    Private Sub toolbarCheckIn_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles toolbarCheckIn.Click
        ' إنشاء مثيل للنموذج frmReserve
        Dim reserveForm As New frmReserve()

        ' تأكد من تعيين التبويب المطلوب كالتبويب النشط في TabControl1
        reserveForm.TabControl1.SelectedTab = reserveForm.TabPage2
        ' استبدل TabPage1 باسم التبويب الذي يحتوي على lvlreserve

        ' عرض النموذج كـ Dialog
